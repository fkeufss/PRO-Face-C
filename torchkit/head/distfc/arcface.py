...
from torchkit.head.distfc.common import CommonFace
...
class ArcFace(CommonFace):
    ...
    def forward(self, embeddings, labels):
        index, part_labels, cos_theta, original_logits = self._calc_logits(embeddings, labels) # calculate original logits
