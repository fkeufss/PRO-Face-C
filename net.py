...
class Backbone(Module):
    ...
    def forward(self, x, aux_list=None, key_list=None):
        ...
        for idx, module in enumerate(self.body):
            ...
            if aux_list is not None:
                # IR_50
                # if idx == 2 or idx == 6 or idx == 20 or idx == 23:
                # IR_101
                if idx == 2 or idx == 15 or idx == 45 or idx == 48:
                    x = self.activation(x) * aux_list[i] * key_list[i] + x
                    i = i + 1
